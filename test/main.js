...
describe("Flatten", function() {
	it("should flatten an array (small, manual)", function() {
		var arr = [ [1, 2, [3] ], 4],
			exp = [1, 2, 3, 4];
	...
	it("should flatten an array (large, controlled and generated)", function() {
		var master = [],
			generated = generate(4, 40, master),
			flattened = flatten(generated);

		assert.deepEqual(master, flattened);
	});
